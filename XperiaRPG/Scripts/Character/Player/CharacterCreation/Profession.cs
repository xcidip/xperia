...
{ 
    public Profession(string name, string description, string armorType, AttributeBonus attributeBonus, string howToPlay) 
        : base(name)
    {
...
public class ProfessionList : ChoiceList
{
    public ProfessionList()
    {
        ...
        {
            new Profession("Warrior", "Slam, Block, Execute", "Plate", new AttributeBonus("Strength",10, "points"),
            ...
            new Profession("Mage", "Fireball, Frost bolt", "Cloth", new AttributeBonus("Intellect",10, "points"),
            ...
            new Profession("Hunter", "Guns, Bows, Crossbows", "Leather", new AttributeBonus("Agility",10, "points"),
