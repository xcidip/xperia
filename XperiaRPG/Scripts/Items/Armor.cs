    ...
    public class Armor : Equipable
{
    ...
    public Armor(int requiredLevel, GearSlot gearSlot, string armorType, string name,int price, string description, List<AttributeBonus> attributeBonusList, (ConsoleColor Foreground, ConsoleColor Background) colors) 
